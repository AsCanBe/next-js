  ...
  <FooterWrapper className="wrapper">
    ...
    <div className="flexbox--desktop">
      ...
      >
        ...
        <span><a href="http://encorewellness.co.uk/" target="_blank"><img src="/static/encore-wellness.png" /></a></span>
      </div>
      <address className="padded align--center--mobile">
        <span><strong>Stowmarket</strong></span>
        <span>Helianthus Counselling</span>
        <span>Church House, Church Road</span>
